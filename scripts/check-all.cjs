...
const nodeChecks = [
  ...
  ["check-adsense-content-surfaces.cjs"],
  ["check-beginners-guide.cjs"],
  ["build-beginner-tutorials.cjs", "--check"],
  ...
  ["check-smartphone-guide.cjs"],
  ["check-smartphone-app-reference.cjs"],
  ["check-vehicle-operation-guide.cjs"],
  ["check-ui-system.cjs"],
  ["check-animals.cjs"],
