...
<link rel="icon" type="image/png" sizes="32x32" href="../assets/img/favicon-32.png">
  ...
  <link rel="stylesheet" href="../assets/css/style.css?v=20260809-i18n3">
...
${renderRoster(data.confirmedSystems)}
  ...
  <script src="../assets/js/main.js?v=20260809-i18n3" defer></script>
...
<head>
  ...
  <link rel="icon" type="image/png" sizes="32x32" href="/assets/img/favicon-32.png"><link rel="stylesheet" href="/assets/css/style.css?v=20260809-i18n3"><script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-4804883741146501" crossorigin="anonymous"></script>
</head>
<body>
...
${zhBodyParts.join("\n")}
  ...
  <footer class="site-footer"><div class="container"><div class="footer-bottom"><span>&copy; <span data-year></span> The Ranchers Guide</span><span>购买价、零售价、出售收入严格分开</span></div></div></footer><script src="/assets/js/main.js?v=20260809-i18n3" defer></script>
</body></html>
`;
