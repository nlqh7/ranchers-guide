...
${renderZhExtra(data.zhExtra)}
  ...
  <footer class="site-footer"><div class="container"><div class="footer-bottom"><span>&copy; <span data-year></span> The Ranchers Guide</span><span>证据等级与版本标注与英文页一致</span></div></div></footer><script src="/assets/js/main.js?v=20260809-i18n5" defer></script>
</body></html>
`;
