...
for (const route of ["/404", "/contribute", "/search", "/zh/search", "/research", "/tools/field-notes"]) {
...
for (const relative of ["404.html", "contribute.html", "search.html", "zh/search.html", "research.html", "tools/field-notes.html"]) {
